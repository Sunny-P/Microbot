                ...
                else
                {
                    ...
                    switch (_config.SelectedCreature())
                    {
                        case UNICOW:
                            ...
                            {
                                Microbot.log("No cowhides found in bank! Shutting down.");
                                this.shutdown();
                                break;
                            }
                            ...
                            {
                                Rs2Bank.withdrawX(ItemID.COW_HIDE, 25);
                                Rs2Inventory.waitForInventoryChanges(3000);
                            }
                            else
                            {
                        ...
                        case SPIDINE:
                            ...
                            {
                                Microbot.log("No raw sardines found in bank! Shutting down.");
                                this.shutdown();
                                break;
                            }
                            ...
                            if (_config.ArdougneMediumDiaryDone())
                            {
                                Rs2Bank.withdrawX(ItemID.RAW_SARDINE, 25);
                                Rs2Inventory.waitForInventoryChanges(3000);
                            }
                            else
                            {

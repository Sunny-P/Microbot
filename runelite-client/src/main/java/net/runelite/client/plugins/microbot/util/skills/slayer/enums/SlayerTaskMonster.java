...
public enum SlayerTaskMonster {
    ...
    CRAB("Crab", 1, new String[]{"Fossil Island", "Ruins of Tapoyauik", "Catacombs of Kourend", "North of Rellekka", "Avium Savannah", "Crabclaw Isle", "Hosidius - southern coast"}, new String[]{"None"}, new String[]{"None"}, new String[]{"None"}, new String[]{"Ammonite Crab", "Frost Crab", "King Sand Crab", "Rock Crab", "Sand Crab"}, new String[]{"Mazchna", "Vannaka", "Chaeldar"}),
    ...
    MOLANISK("Molanisk", 39, new String[]{"Dorgesh-Kaan South Dungeon"}, new String[]{"Slayer bell", "Bullseye lantern"}, new String[]{"None"}, new String[]{"Melee"}, new String[]{"None"}, new String[]{"Vannaka"}),
    ...
    WALL_BEAST("Wall beast", 35, new String[]{"Lumbridge Swamp Caves"}, new String[]{"Spiny helmet", "Slayer helmet", "Bullseye lantern"}, new String[]{"None"}, new String[]{"Melee"}, new String[]{"None"}, new String[]{"Mazchna", "Vannaka", "Chaeldar"}),

            ...
            switch (CardewSlayerScript.currentState){
                case MOVING_TO_SLAYER_MASTER:
                    panelComponent.getChildren().add(LineComponent.builder()
                            .left("State: Moving to Slayer Master")
                            .build());
                    break;
                case GETTING_SLAYER_TASK:
                    panelComponent.getChildren().add(LineComponent.builder()
                            .left("State: Getting Slayer Task")
                            .build());
                    break;
                case MOVING_TO_MONSTER_LOCATION:
                    panelComponent.getChildren().add(LineComponent.builder()
                            .left("State: Moving to Monster Location")
                            .build());
                    break;
                case SLAYING_MONSTER:
                    panelComponent.getChildren().add(LineComponent.builder()
                            .left("State: Slaying Monster")
                            .build());
                    break;
                case MOVING_TO_NEAREST_BANK:
                    panelComponent.getChildren().add(LineComponent.builder()
                            .left("State: Moving to Nearest Bank")
                            .build());
                    break;
                case BANKING:
                    panelComponent.getChildren().add(LineComponent.builder()

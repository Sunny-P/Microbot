...
public interface CardewSlayerConfig extends Config{
    ...
    @ConfigItem(
            name = "Bloodveld Alternative Task",
            keyName = "bloodveldAlternativeTask",
            position = 8,
            description = "The location you will slay Bloodvelds",
            section = taskAlternativeSection
    )
    default CUtil.AlternativeBloodveldTask AlternativeBloodveldTask() { return CUtil.AlternativeBloodveldTask.BLOODVELD_SLAYER_TOWER_BASEMENT; }

    @ConfigItem(
            name = "Blue Dragon Alternative Task",
            keyName = "blueDragonAlternativeTask",
            position = 9,
            description = "The location and monster you will slay Blue dragons",
            section = taskAlternativeSection
    )
    default CUtil.AlternativeBlueDragonTask AlternativeBlueDragonTask() { return CUtil.AlternativeBlueDragonTask.BLUE_DRAGON_UPPER_TAVERLY; }

    @ConfigItem(
            name = "Hellhound Alternative Task",
            keyName = "hellhoundAlternativeTask",
            position = 10,
            description = "The location you will slay Hellhounds",
            section = taskAlternativeSection
    )
    default CUtil.AlternativeHellhoundTask AlternativeHellhoundTask() { return CUtil.AlternativeHellhoundTask.HELLHOUND_CATACOMBS_OF_KOUREND; }

    @ConfigItem(
            name = "Jelly Alternative Task",
            keyName = "jellyAlternativeTask",
            position = 11,
            description = "The Jelly you will slay",
            section = taskAlternativeSection
    )
    default CUtil.AlternativeJellyTask AlternativeJellyTask() { return CUtil.AlternativeJellyTask.JELLY_FREMENNIK_SLAYER_CAVE; }

    @ConfigItem(
            name = "Lesser Demon Alternative Task",
            keyName = "lesserDemonAlternativeTask",
            position = 12,
            description = "The location you will slay Lesser demons",
            section = taskAlternativeSection
    )
    default CUtil.AlternativeLesserDemonTask AlternativeLesserDemonTask() { return CUtil.AlternativeLesserDemonTask.LESSER_DEMON_CRANDOR_DUNGEON; }

...
public class CUtil {
    ...
    /**
     * Compares nameA to nameB ignoring spaces in the name.<br>
     * I.e this method would return true if 'Flesh crawler' is compared against 'fleshcrawler'
     * @param nameA First name
     * @param nameB Second name
     * @return true if nameA equals nameB regardless of spaces.<br> false otherwise.
     */
    ...
    public enum SlayerTarget {
        ...
        ANKOU(SlayerTaskMonster.ANKOU, new WorldPoint(2360, 5243, 0)),
        BANSHEE(SlayerTaskMonster.BANSHEE, new WorldPoint(3436, 3558, 0)),
        BASILISK(SlayerTaskMonster.BASILISK, new WorldPoint(2743, 10008, 0)),
        ...
        BLOODVELD(SlayerTaskMonster.BLOODVELD, new WorldPoint(0, 0, 0)),    // Alt
        BLUE_DRAGON(SlayerTaskMonster.BLUE_DRAGON, new WorldPoint(0, 0, 0)),
        ...
        DAGANNOTH(SlayerTaskMonster.DAGANNOTH, new WorldPoint(1677, 9997, 0)), // Currently kourend dungeon. Can extend into Alternative tasks for Lighthouse?
        ...
        FEVER_SPIDER(SlayerTaskMonster.FEVER_SPIDER, new WorldPoint(3678, 3536, 0)),
        ...
        HARPIE_BUG_SWARM(SlayerTaskMonster.HARPIE_BUG_SWARM, new WorldPoint(2865, 3111, 0)),
        HELLHOUND(SlayerTaskMonster.HELLHOUND, new WorldPoint(0, 0, 0)),    // Alt
        ...
        ICE_GIANT(SlayerTaskMonster.ICE_GIANT, new WorldPoint(2960, 9573, 0)),
        ICE_WARRIOR(SlayerTaskMonster.ICE_WARRIOR, new WorldPoint(3044, 9582, 0)),
        INFERNAL_MAGE(SlayerTaskMonster.INFERNAL_MAGE, new WorldPoint(3446, 3557, 1)),
        JELLY(SlayerTaskMonster.JELLY, new WorldPoint(0, 0, 0)),    // Alt
        ...
        LESSER_DEMON(SlayerTaskMonster.LESSER_DEMON, new WorldPoint(0, 0, 0)),  // Alt
        ...
        MOLANISK(SlayerTaskMonster.MOLANISK, new WorldPoint(2736, 5206, 0)),
        MONKEY(SlayerTaskMonster.MONKEY, new WorldPoint(2877, 3154, 0)),
        OTHERWORLDLY_BEING(SlayerTaskMonster.OTHERWORLDLY_BEING, new WorldPoint(2388, 4427, 0)),
        ...
        WEREWOLF(SlayerTaskMonster.WEREWOLF, new WorldPoint(3491, 3487, 0)),
    ...
    @Getter
    public enum AlternativeBloodveldTask {
        BLOODVELD_STRONGHOLD_SLAYER_CAVE("Bloodveld", new WorldPoint(2444, 9819, 0)),
        BLOODVELD_SLAYER_TOWER("Bloodveld", new WorldPoint(3422, 3562, 1)),
        BLOODVELD_SLAYER_TOWER_BASEMENT("Bloodveld", new WorldPoint(3418, 9937, 3));

        private final String monsterName;
        private final WorldPoint location;

        AlternativeBloodveldTask(String _monsterName, WorldPoint _location)
        {
            this.monsterName = _monsterName;
            this.location = _location;
        }
    ...
    @Getter
    public enum AlternativeBlueDragonTask {
        BLUE_DRAGON_ISLE_OF_SOULS("Blue dragon", new WorldPoint(2127, 9312,0)),
        BLUE_DRAGON_TAVERLY_DUNGEON("Blue dragon", new WorldPoint(2918, 9781, 0)),
        BLUE_DRAGON_UPPER_TAVERLY("Blue dragon", new WorldPoint(2937, 9820, 1)),
        BABY_BLUE_DRAGON_TAVERLY_DUNGEON("Baby blue dragon", new WorldPoint(2895, 9771, 0));

        private final String monsterName;
        private final WorldPoint location;

        AlternativeBlueDragonTask(String _monsterName, WorldPoint _location)
        {
            this.monsterName = _monsterName;
            this.location = _location;
        }
    ...
    @Getter
    public enum AlternativeLesserDemonTask {
        LESSER_DEMON_CRANDOR_DUNGEON("Lesser demon", new WorldPoint(2836, 9570, 0)),
        LESSER_DEMON_CATACOMBS_OF_KOUREND("Lesser demon", new WorldPoint(1707, 10066, 0));

        private final String monsterName;
        private final WorldPoint location;

        AlternativeLesserDemonTask(String _monsterName, WorldPoint _location)
        {
            this.monsterName = _monsterName;
            this.location = _location;
        }
    ...
    @Getter
    public enum AlternativeJellyTask {
        JELLY_FREMENNIK_SLAYER_CAVE("Jelly", new WorldPoint(2706, 10027, 0)),
        WARPED_JELLY_LVL112("Warped Jelly", new WorldPoint(1715, 10051, 0));

        private final String monsterName;
        private final WorldPoint location;

        AlternativeJellyTask(String _monsterName, WorldPoint _location)
        {
            this.monsterName = _monsterName;
            this.location = _location;
        }
    ...
    @Getter
    public enum AlternativeHellhoundTask {
        HELLHOUND_STRONGHOLD_SLAYER_CAVE("Hellhound", new WorldPoint(2419, 9784, 0)),
        HELLHOUND_TAVERLY_DUNGEON("Hellhound", new WorldPoint(2868, 9842, 0)),
        HELLHOUND_CATACOMBS_OF_KOUREND("Hellhound", new WorldPoint(1644, 10065, 0));

        private final String monsterName;
        private final WorldPoint location;

        AlternativeHellhoundTask(String _monsterName, WorldPoint _location)
        {
            this.monsterName = _monsterName;
            this.location = _location;
        }
    ...
    @Getter
    public enum WerewolfCanifisHumanNames {
        ALEXIS("Alexis"),
        BORIS("Boris"),
        EDUARD("Eduard"),
        GALINA("Galina"),
        ...
        WerewolfCanifisHumanNames(String name) { this.name = name; }
    }
}
